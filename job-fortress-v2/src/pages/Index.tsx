  ...
  return (
    <>
      ...
      {phase === 'reveal' && (scanReport ? (
        <Suspense fallback={<div className="min-h-screen bg-background flex items-center justify-center"><div className="animate-pulse text-muted-foreground">Loading results...</div></div>}><AIDossierReveal report={scanReport} onComplete={handleRevealComplete} scanId={scanId} /></Suspense>
      ) : (
        <div className="min-h-screen bg-background flex items-center justify-center">
