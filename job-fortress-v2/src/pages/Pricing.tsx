    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-10">
        ...
        <div className="rounded-2xl border-2 border-primary bg-card p-8 space-y-6">
          ...
          <button
            disabled
            className="w-full py-3.5 rounded-xl bg-primary/60 text-primary-foreground font-black text-sm transition-all flex items-center justify-center gap-2 cursor-not-allowed min-h-[48px]"
          >
        ...
        <div className="space-y-4 pt-4">
          ...
          {[
            { q: 'What do I get?', a: 'Both reports — your full Risk Diagnosis and Growth Playbook — all features unlocked.' },
            { q: 'Can I cancel?', a: 'Yes. Cancel anytime. You keep access until the period ends.' },
