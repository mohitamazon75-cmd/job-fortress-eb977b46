...
const PRO_FEATURES = [
  { label: 'Know exactly which skills to protect — week by week' },
  { label: 'Real salary data: are you underpaid by ₹2L+?' },
  { label: 'Your personalized 90-day career defense plan' },
  { label: 'Unlimited AI coach — ask anything about your scan' },
  { label: 'Track your career score monthly — see your progress' },
];
        ...
        handler: async (response: { razorpay_payment_id: string; razorpay_order_id?: string }) => {
          try {
            ...
            toast.success('Pro unlocked!', {
              description: 'All premium features are now active.',
              duration: 5000,
            });
          ...
          <div className="px-5 pt-6 pb-5 border-b border-border flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <h2 className="text-lg font-black text-foreground leading-tight mb-2">
                You've seen the risk.
              </h2>
              <p className="text-sm text-foreground font-semibold mb-3">Here's how to beat it.</p>
