...
EXPLICIT_MAP = {
    ...
    "motion_designer": ["Special effects artists and animators", "Graphic designers"],
    ...
    "risk_analyst": ["Financial analysts"],
    ...
    # Tech roles
    "backend_developer": ["Software developers, quality assurance analysts, and testers"],
    "frontend_developer": ["Web developers and digital designers"],
    "full_stack_developer": ["Software developers, quality assurance analysts, and testers"],
    "mobile_developer": ["Software developers, quality assurance analysts, and testers"],
    "ml_engineer": ["Software developers, quality assurance analysts, and testers", "Computer and information research scientists"],
    ...
    "devops_engineer": ["Software developers, quality assurance analysts, and testers", "Network and computer systems administrators"],
    "cloud_architect": ["Computer network architects"],
    "solutions_architect": ["Computer network architects", "Software developers, quality assurance analysts, and testers"],
    "database_administrator": ["Database administrators and architects"],
    "cybersecurity_analyst": ["Information security analysts"],
    "it_support_engineer": ["Computer support specialists"],
    "qa_tester": ["Software developers, quality assurance analysts, and testers"],
    "manual_qa_engineer": ["Software developers, quality assurance analysts, and testers"],
    "ui_ux_designer": ["Web developers and digital designers", "Graphic designers"],
    "product_designer": ["Web developers and digital designers", "Graphic designers"],
    # Marketing / sales
    "digital_marketer": ["Market research analysts"],
    "performance_marketer": ["Market research analysts"],
    "email_marketer": ["Market research analysts"],
    "social_media_manager": ["Market research analysts", "Public relations specialists"],
    ...
    # PM / ops
    "product_manager": ["Computer and information systems managers"],  # Imperfect; PMs aren't in BLS taxonomy
    ...
    "data_entry_operator": [],  # No exact Atlas occupation; honest empty state beats false precision
