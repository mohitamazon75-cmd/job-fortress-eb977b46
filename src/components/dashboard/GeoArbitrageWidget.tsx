      ...
      <div className="grid md:grid-cols-2 gap-3">
        <div className="rounded-xl border border-prophet-green/20 bg-prophet-green/5 p-4">
          ...
          <div className="space-y-2 mt-3">
            ...
            <div className="flex justify-between items-center">
              {/* CRITICAL-8 fix: label reflects this is P(success) × annual delta — an
                  expected value, not a guaranteed outcome. */}
              <span className="text-xs text-muted-foreground">Expected value if relocation succeeds</span>
