...
const MOATS = [
  ...
  },
  {
    ...
    headline: '98 Role Archetypes × 30 Skill Categories. India-Calibrated.',
    desc: 'A structured database with weighted edges mapping automation risk, AI augmentation potential, and human edge strength — calibrated from O*NET, ESCO, NASSCOM, and Indian labor market data. Same skill, different risk, by industry and seniority.',
    stats: [
      { label: '98', sublabel: 'role archetypes' },
      { label: '30+', sublabel: 'skill categories' },
    ],
