...
const FAMILY_TOKENS: Array<{ family: string; tokens: string[] }> = [
  ...
  // → project_manager, mis-filtering Card 4 pivots. Tokens are matched as substrings against
  // the lowercased role; ordering matters only insofar as the first family wins.
