...
export class RiskKnowledgeGraph {
  ...
  private _loadCities() {
    const cities: CityNode[] = [
      ...
      { id: "bangalore", name: "Bangalore", ai_adoption_multiplier: 1.25, tech_talent_density: 0.78, labor_market_resilience: 0.58, avg_transition_support: 0.62, emerging_roles_index: 1.35 },
      { id: "mumbai", name: "Mumbai", ai_adoption_multiplier: 1.10, tech_talent_density: 0.65, labor_market_resilience: 0.55, avg_transition_support: 0.58, emerging_roles_index: 1.15 },
      { id: "other", name: "Other", ai_adoption_multiplier: 0.95, tech_talent_density: 0.45, labor_market_resilience: 0.55, avg_transition_support: 0.55, emerging_roles_index: 0.95 },
    ];
